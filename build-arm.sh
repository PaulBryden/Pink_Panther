...
cmake -G Ninja -H../Pink_Panther/submodules/lapack/. -B. -DCMAKE_TOOLCHAIN_FILE=/home/green/software/Pink_Panther/cmake/toolchain-arm-linux-gnueabihf.cmake -DRASPBERRY_PI=ON -DCMAKE_BUILD_TYPE=Debug -DBUILD_SHARED_LIBS=0 && DESTDIR=./ ninja install
rm CMakeCache.txt
...
rm CMakeCache.txt
cmake -G Ninja -H../Pink_Panther/. -B.  -DCMAKE_INSTALL_PREFIX=/usr/arm-linux-gnueabihf -DCMAKE_TOOLCHAIN_FILE=/home/green/software/Pink_Panther/cmake/toolchain-arm-linux-gnueabihf.cmake -DRASPBERRY_PI=ON -DCMAKE_BUILD_TYPE=Debug -DBUILD_SHARED_LIBS=0 && DESTDIR=./ ninja
